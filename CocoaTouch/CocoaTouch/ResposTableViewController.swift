...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let repo1 = Repo(name: "Test Repo 1", url: URL(string: "https://exaple.com/repo1"))
        let repo2 = Repo(name: "Test Repo 2", url: URL(string: "https://exaple.com/repo2"))
